...
open class UISideMenuNavigationController: UINavigationController {
	...
	private weak var activeDelegate: UISideMenuNavigationControllerDelegate? {
		get {
	...
	private func findDelegate(forViewController: UIViewController?) -> UISideMenuNavigationControllerDelegate? {
	...
	private var usingInterfaceBuilder = false
