...
open class SideMenuManager : NSObject {
	...
	*/
	...
	private func setupNavigationController(_ forMenu: UISideMenuNavigationController?, leftSide: Bool) {
	...
	private func updateMenuBlurIfNecessary() {
	...
	private func setupMenuBlurForMenu(_ forMenu: UISideMenuNavigationController?) {
	...
	private func removeMenuBlurForMenu(_ forMenu: UISideMenuNavigationController?) {
		guard let forMenu = forMenu,
